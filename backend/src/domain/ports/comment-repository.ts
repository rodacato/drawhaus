...
export interface CommentRepository {
  findByDiagram(diagramId: string, sceneId?: string | null, currentUserId?: string): Promise<CommentThread[]>;
  findThreadById(id: string, currentUserId?: string): Promise<CommentThread | null>;
  ...
  toggleLike(threadId: string, userId: string): Promise<boolean>;
}

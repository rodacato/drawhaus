    ...
    <div className="relative grid min-h-screen place-items-center bg-surface px-4 py-8 overflow-hidden">
      ...
      <section className={`${ui.card} relative w-full max-w-110 space-y-6`}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button type="button" className="flex items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium text-text-primary transition hover:bg-surface">

            ...
            {!isInviteMode && (
              <>
                <div className="space-y-2">
                  <button type="button" onClick={() => { globalThis.location.href = `${API_URL}/api/auth/google`; }} className="flex w-full items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium text-text-primary transition hover:bg-surface">
                  ...
                  <button type="button" onClick={() => { globalThis.location.href = `${API_URL}/api/auth/github`; }} className="flex w-full items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium text-text-primary transition hover:bg-surface">

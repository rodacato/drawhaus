...
export function Settings() {
  ...
  async function handlePasswordSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setPasswordStatus({
        type: "error",
        message: msg === "Unauthorized" ? "Current password is incorrect" : msg,
      });
    } finally {
      setPasswordPending(false);
    }
          ...
          {activeTab === "profile" && (
            <div className={ui.card}>
              ...
              <form onSubmit={handleProfileSubmit} className="mt-4 space-y-4">
                ...
                {profileStatus && (
                  <p className={profileStatus.type === "error" ? ui.alertError : ui.alertSuccess}>
            ...
            <>
              <div className={ui.card}>
                ...
                <form onSubmit={handlePasswordSubmit} className="mt-4 space-y-4">
                  ...
                  {passwordStatus && (
                    <p
                      className={passwordStatus.type === "error" ? ui.alertError : ui.alertSuccess}
                    >
                  ...
                  >
                    {passwordPending ? "Changing..." : "Update Password"}
                  </button>
                </form>
              </div>
            ...
            <div className={ui.card}>
              ...
              <div className="rounded-xl border border-border bg-surface p-6 text-center">
                ...
                <p className="mt-2 text-sm text-text-secondary">
                  You are running Drawhaus on your own infrastructure. No billing information
                  required.
                </p>

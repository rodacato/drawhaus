...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Paste Mermaid or PlantUML code and get editable Excalidraw elements on your canvas.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    description:
      "Programmatic CRUD for diagrams via /v1/ endpoints. API key auth, rate limiting, OpenAPI spec.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    title: "MCP Server",
    description:
      "AI agents in Claude Code, Cursor, or VS Code create and manage diagrams via natural language.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    description:
      "Leave feedback directly on the canvas with threaded discussions and resolve workflow.",
    icon: (
      <svg
        width="24"
        height="24"
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Yes, 100% free and open source under the MIT license. Self-host on your own server — no subscriptions, no usage limits, no data collection.",
  },
  {
    question: "How is this different from Excalidraw?",
    answer:
      "Same incredible editor. Drawhaus adds the infrastructure layer: user auth, workspaces with roles, persistent storage, share links, snapshots, admin panel, REST API, and MCP server for AI tools.",
  },
  {
    question: "Do I need Excalidraw+ to use this?",
    answer:
      "No. Drawhaus is fully standalone. It's built on Excalidraw's open-source editor — you don't need an Excalidraw+ subscription.",
  },
  {
    question: "How hard is it to deploy?",
    answer:
      "One command: docker compose up. A 3-step setup wizard guides you through creating your admin account and configuring integrations — no .env editing required.",
  },
  {
    question: "Can AI tools create diagrams?",
    answer:
      "Yes. The @drawhaus/mcp package lets Claude Code, Cursor, and VS Code create, read, update, and delete diagrams via natural language. AI-generated diagrams are fully editable in the editor.",
  },
  {
    question: "Is my data secure?",
    answer:
      "You own the server, you own the data. Drawhaus includes AES-256 encrypted secrets, role-based access control, rate limiting, security headers, and structured audit logging.",
  },
  {
    question: "Can I use it with my team?",
    answer:
      "Yes. Workspaces with admin/editor/viewer roles, real-time collaboration with live cursors, share links with expiration, threaded comments, and Google Drive backup.",
  },
];
  ...
  return (
    <details className="group border-b border-border pb-4">
      <summary className="flex cursor-pointer items-center justify-between py-4 font-sora text-base font-semibold transition hover:text-primary">
        {question}
        <svg
          className="h-5 w-5 shrink-0 text-text-muted transition group-open:rotate-45"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
      ...
      <nav className="sticky top-0 z-50 border-b border-border/50 bg-surface/80 backdrop-blur-lg">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="hidden items-center gap-6 text-sm text-text-secondary sm:flex">
            ...
            <Link to="/self-host" className="transition hover:text-text-primary">
              Self-Host
            </Link>
            <a
              href={GITHUB_URL}
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-lg text-lg text-text-secondary">
              Self-hosted collaborative diagramming built on Excalidraw. Real-time collab, REST API,
              MCP for AI tools, diagram-as-code — all on your infrastructure.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="mb-16 text-center">
          ...
          <p className="mt-3 text-text-secondary">
            The features teams actually need, on infrastructure you control.
          </p>
        </div>
        ...
        <div className="mb-20 grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-text-secondary">
              Self-hosted on your infrastructure. Your diagrams never leave your server. AES-256
              encrypted secrets, structured audit logging, and role-based access control.
            </p>
        ...
        <div className="mb-20 grid items-center gap-12 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-3 text-text-secondary">
              Real-time collaboration with live cursors, threaded comments, and workspaces for
              organizing by team or client.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-text-secondary">
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
              ...
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
                Share links with role &amp; expiration
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
                Persistent snapshot versioning
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
                Presence indicators &amp; viewport follow
              </li>
            </ul>
          </div>
          <div className="order-1 lg:order-2">
            <ScreenshotFrame
              src="/screenshots/screenshot-collab.png"
              alt="drawhaus — collaboration"
            />
          </div>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="space-y-4">
            <ScreenshotFrame
              src="/screenshots/screenshot-code-import-plantuml.png"
              alt="drawhaus — PlantUML import"
            />
            <ScreenshotFrame
              src="/screenshots/screenshot-code-import-mermaid.png"
              alt="drawhaus — Mermaid import"
            />
          </div>
          <div>
            <h3 className="font-sora text-2xl font-bold">Developer-first workflow</h3>
            <p className="mt-3 text-text-secondary">
              Paste Mermaid or PlantUML code and get editable elements. Use the REST API or MCP
              server to create diagrams programmatically. AI agents draw for you.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-text-secondary">
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
                Mermaid &amp; PlantUML diagram-as-code import
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-primary" />
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="group rounded-xl border border-border bg-surface p-6 transition hover:border-primary/30 hover:shadow-lg"
              >
      ...
      <section className="bg-surface-raised/50 py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-text-secondary">
            No pricing tiers. No feature gates. No "contact sales". Self-host on your own server and
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg border border-border px-6 py-3 text-sm font-semibold text-text-secondary transition hover:bg-surface hover:text-text-primary"
            >
              View Source
            </a>
          </div>

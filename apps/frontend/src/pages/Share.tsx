      ...
      <div className="relative grid min-h-screen place-items-center bg-surface px-4 py-8 overflow-hidden">
          ...
          <div className="space-y-5 px-8 pb-8 pt-4">
            <div className="space-y-1 text-center">
              ...
              <p className="text-sm text-text-muted">
                {canEdit
                  ...
                  : "You've been invited to view this diagram."}
              </p>
            </div>
            <form
              onSubmit={(e) => {
            ...
            >
              <label className={ui.label}>
                ...
                <div className="relative">
                  ...
                  <input
                    className={`${ui.input} h-12 pl-11 text-base`}
                    type="text"
              ...
              <button
                type="submit"
                className={`${ui.btn} ${ui.btnPrimary} h-12 w-full gap-2 text-base shadow-lg shadow-primary/20`}
              >
            ...
            <div className="flex flex-col items-center gap-3 pt-1">
              <div className="flex items-center gap-2 rounded-full bg-surface px-3 py-1.5 ring-1 ring-inset ring-border">
                ...
                <span className="text-xs font-medium uppercase tracking-tight text-text-muted">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 opacity-60">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight text-text-primary font-[family-name:var(--font-family-heading)]">
              Drawhaus
            </span>
          </div>
      ...
      <div className="pointer-events-none fixed left-4 top-3 z-20 flex flex-col gap-1">
        <div className="flex items-center gap-3">
          <div className="pointer-events-auto rounded-lg bg-white px-4 py-2 shadow-sm">
            <span className="text-lg font-medium text-[#1b1b1f]">{data.title || "Untitled"}</span>
          </div>
        ...
        <div className="pointer-events-auto flex items-center gap-2">
          <div
            className={`w-fit rounded-full px-2.5 py-1 text-[10px] font-medium shadow-sm ${statusBadge.className}`}
          >
            {statusBadge.label}
          </div>
          <CollaborationBadge

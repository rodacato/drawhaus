...
const coreColors = [
  {
    ...
    hex: "#E95B2D",
    usage: "Brand accent, CTAs, hero elements",
  },
  {
    name: "Accent Yellow",
    var: "--color-accent-yellow",
    hex: "#FBBF24",
    usage: "Highlights, callouts (sparingly)",
  },
  {
    name: "Primary Blue",
    var: "--color-primary",
    hex: "#0EA5E9",
    usage: "Interactive: buttons, links, active states",
  },
  {
    name: "Primary Hover",
  ...
  },
  {
    ...
    hex: "#F97316",
    usage: "Badges, tags, attention elements",
  },
  { name: "Dark Base", var: "--color-surface-dark", hex: "#111827", usage: "Dark mode background" },
  {
    ...
    var: "--color-surface",
    hex: "#F8FAF3",
    usage: "Light mode background (warm off-white)",
  },
];
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div>
        ...
        <p className="font-[family-name:var(--font-family-mono)] text-xs text-text-muted">
          {cssVar}
        </p>
  ...
  return (
    <div className="space-y-8">
      ...
      <Section id="brand" title="Brand" description="Core identity and messaging.">
        <div className="space-y-4">
          ...
          <p className="text-sm text-text-secondary">
            Diagrams &amp; Whiteboards. <strong>Self-Hosted.</strong>
          </p>
          ...
          <div className="space-y-2 rounded-lg bg-surface p-4">
            ...
            <p className="text-sm text-text-secondary">
              <strong>Direct. Honest. Smart.</strong> Write like talking to a peer, not a customer.
            </p>
            <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
              <div className="rounded-lg bg-error/10 px-3 py-2 text-error">
                "We're thrilled to introduce our new feature"
              </div>
              <div className="rounded-lg bg-success/10 px-3 py-2 text-success">
                "New: export to PNG and SVG"
              </div>
              <div className="rounded-lg bg-error/10 px-3 py-2 text-error">
                "Leverage our powerful platform"
              </div>
              <div className="rounded-lg bg-success/10 px-3 py-2 text-success">
                "Draw diagrams. Own your data."
              </div>
            </div>
          </div>
        </div>
      ...
      <Section
        id="logos"
        title="Logo System"
        description="Available logo variants. Use the right variant for each context."
      >
      ...
      <Section
        id="core-colors"
        title="Core Colors"
        description="Primary brand palette with usage guidelines."
      >
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
          {textColors.map((c) => (
            <div key={c.var} className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-sm font-medium" style={{ color: c.hex }}>
                  {c.name}
                </p>
                <p className="font-[family-name:var(--font-family-mono)] text-xs text-text-muted">
                  {c.hex}
      ...
      <Section
        id="typography"
        title="Typography"
        description="Three-font system: Sora for headings, Inter for body, JetBrains Mono for code."
      >
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-base">
              The quick brown fox jumps over the lazy dog. Drawhaus is a modern, self-hosted
              diagramming tool for teams who value data ownership.
            </p>
            <p className="mt-1 text-sm text-text-secondary">
              ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz 0123456789
            </p>
            <p className="mt-2 text-xs text-text-muted">
              Min body: 14px (web), 16px (mobile) &middot; Line-height: 1.5 body, 1.2 headings
            </p>
          </div>
          <hr className="border-border" />
          <div>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2">
              <p className="text-3xl font-semibold font-[family-name:var(--font-family-heading)] tracking-tight">
                H1 — 30px / 1.2
              </p>
              <p className="text-xl font-semibold font-[family-name:var(--font-family-heading)]">
                H2 — 20px / 1.2
              </p>
              <p className="text-lg font-semibold font-[family-name:var(--font-family-heading)]">
                H3 — 18px / 1.3
              </p>
      ...
      <Section
        id="buttons"
        title="Buttons"
        description="Button variants from the ui utility. All buttons use rounded-lg, h-10, text-sm font-medium."
      >
        <div className="space-y-6">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              ...
              <button className={`${ui.btn} ${ui.btnPrimary}`} disabled>
                Disabled
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Larger buttons for landing pages and hero sections. Coral for primary CTA, Blue for
              secondary.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Square icon-only buttons for toolbars and actions.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in danger zones and destructive confirmations.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
      ...
      <Section
        id="form-elements"
        title="Form Elements"
        description="Inputs, selects, textareas, toggles, and labels."
      >
        <div className="space-y-6">
          <div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used for search bars and special inputs across dashboard and editor.
            </p>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in settings for boolean options (Allow Registration, Maintenance Mode, etc.)
            </p>
            <div className="mt-3 space-y-4 max-w-md">
              <div className="flex items-center justify-between">
                ...
                >
                  <span
                    className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-sm transition-transform ${toggleA ? "translate-x-[22px]" : "translate-x-[2px]"} mt-[2px]`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                >
                  <span
                    className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-sm transition-transform ${toggleB ? "translate-x-[22px]" : "translate-x-[2px]"} mt-[2px]`}
                  />
                </button>
              </div>
            </div>
      ...
      <Section
        id="badges-tags"
        title="Badges & Tags"
        description="Role indicators, status pills, and category labels."
      >
        <div className="space-y-6">
          <div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used for brand color emphasis in hero sections and marketing.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <span
                className="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium text-white"
                style={{ backgroundColor: "#E95B2D" }}
              >
                Coral
              </span>
              <span
              ...
              <span
                className="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium text-surface-dark"
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in admin tables and user management.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <span className="rounded bg-primary/10 px-2 py-1 text-[10px] font-bold uppercase tracking-tight text-primary">
                Admin
              </span>
              <span className="rounded bg-surface px-2 py-1 text-[10px] font-bold uppercase tracking-tight text-text-secondary">
                Editor
              </span>
              <span className="rounded bg-surface px-2 py-1 text-[10px] font-bold uppercase tracking-tight text-text-muted">
                Viewer
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              ...
              <span className="rounded bg-warning/20 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-warning">
                Pending
              </span>
              <span className="rounded bg-surface px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-text-muted">
                Expires Oct 31
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full bg-surface px-1.5 py-0.5 text-[10px] font-bold uppercase text-text-secondary">
                Dev
              </span>
              <span className="rounded-full bg-surface px-1.5 py-0.5 text-[10px] font-bold uppercase text-text-secondary">
                Marketing
      ...
      <Section
        ...
        description="Transient feedback messages. Auto-dismiss after 3 seconds. Triggered via useToast() hook."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Live Preview</SectionLabel>
            <p className="mt-1 text-xs text-text-muted">
              Click to trigger a real toast notification at the top of the page.
            </p>
      ...
      <Section
        ...
        description="Promise-based confirmation modals. Triggered via useConfirm() hook. Replaces all native window.confirm() calls."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Live Preview</SectionLabel>
              ...
              <button
                ...
                onClick={async () => {
                  const ok = await confirm({
                    ...
                    message:
                      '"User Journey Map V2" will be permanently deleted. This cannot be undone.',
                    confirmLabel: "Delete",
                    variant: "danger",
                  });
            ...
            <div className="mt-3 grid gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-surface-raised p-6 shadow-2xl">
                ...
                <p className="mt-2 text-sm text-text-secondary">
                  "Design Team" will be permanently deleted. All diagrams will revert to their
                  owners' personal workspaces.
                </p>
                <div className="mt-6 flex justify-end gap-3">
                  <button
                    type="button"
                    className="inline-flex h-10 items-center justify-center rounded-lg border border-border bg-surface-raised px-4 text-sm font-medium text-text-primary"
                  >
                    Cancel
                  </button>
                  <button
                    type="button"
                    className="inline-flex h-10 items-center justify-center rounded-lg bg-error px-4 text-sm font-semibold text-white shadow-sm"
                  >
                    Delete Workspace
                  </button>
                </div>
              ...
              <div className="rounded-2xl border border-border bg-surface-raised p-6 shadow-2xl">
                ...
                <p className="mt-2 text-sm text-text-secondary">
                  This will make your diagram visible to anyone with the link.
                </p>
                <div className="mt-6 flex justify-end gap-3">
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    className="inline-flex h-10 items-center justify-center rounded-lg bg-primary px-4 text-sm font-semibold text-white shadow-sm"
                  >
                    Publish
                  </button>
                </div>
      ...
      <Section
        id="cards"
        title="Cards & Panels"
        description="Container patterns used across the app."
      >
        <div className="space-y-6">
          <div>
            ...
            <div className={`${ui.card} mt-3 max-w-sm`}>
              <p className="text-sm text-text-primary">
                This is a card component with rounded corners, border, and raised surface.
              </p>
            </div>
          </div>
          <hr className="border-border" />
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in the admin dashboard for KPI display.
            </p>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Grid card with thumbnail, title, timestamp, and category tag.
            </p>
            <div className="mt-3 max-w-xs">
              <div className="group overflow-hidden rounded-xl border border-border bg-surface-raised transition-all hover:shadow-xl hover:border-primary/30">
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between">
                    <h3 className="truncate pr-2 text-sm font-semibold text-text-primary">
                      User Journey Map V2
                    </h3>
                    <svg
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in settings for destructive actions.
            </p>
      ...
      <Section
        id="navigation"
        title="Navigation"
        description="Sidebar, tabs, and nav item patterns used across the app."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Sidebar Nav Items</SectionLabel>
            <p className="mt-1 text-xs text-text-muted">
              Active item uses primary/10 bg + primary text. Inactive uses hover:bg-surface.
            </p>
            <div className="mt-3 max-w-xs space-y-1">
              <button
                type="button"
                className="flex w-full items-center gap-3 rounded-lg bg-primary/10 px-3 py-2.5 text-left text-sm font-medium text-primary"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
              ...
              <button
                type="button"
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-text-secondary transition-colors hover:bg-surface"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
              ...
              <div className="px-3 pb-1 pt-4 text-[10px] font-bold uppercase tracking-widest text-text-muted">
                Instance
              </div>
              <button
                type="button"
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in comments panel, auth toggle, view switchers.
            </p>
          ...
          <div>
            ...
            <div className="mt-3 flex items-center justify-between text-sm text-text-muted max-w-md">
              ...
              <div className="flex gap-2">
                <button
                  className="rounded-lg border border-border p-1.5 text-text-muted opacity-50"
                  disabled
                >
                  <svg
                    className="h-4 w-4"
      ...
      <Section
        id="avatars"
        title="Avatars"
        description="User identity elements used in navbars, comments, and collaboration."
      >
        <div className="space-y-6">
          <div>
            ...
            <div className="mt-3 flex items-end gap-4">
              ...
              <div className="flex flex-col items-center gap-1">
                <div className="h-12 w-12 rounded-full border-2 border-primary bg-surface flex items-center justify-center text-sm font-bold text-primary">
                  AS
                </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Used in collaboration headers to show active participants.
            </p>
            <div className="mt-3 flex items-center gap-3">
              <div className="flex -space-x-2">
                <div className="h-8 w-8 rounded-full border-2 border-surface-raised bg-primary/20 text-primary flex items-center justify-center text-xs font-bold">
                  AR
                </div>
                <div className="h-8 w-8 rounded-full border-2 border-surface-raised bg-accent-coral/20 text-accent-coral flex items-center justify-center text-xs font-bold">
                  SC
                </div>
                <div className="h-8 w-8 rounded-full border-2 border-surface-raised bg-surface text-text-muted flex items-center justify-center text-[10px] font-bold">
                  +3
                </div>
              </div>
      ...
      <Section id="table" title="Table" description="Data table pattern used in admin panel.">
        <div className="overflow-hidden rounded-xl border border-border">
          <div className="flex items-center justify-between border-b border-border bg-surface/50 px-6 py-3">
            ...
            <div className="flex gap-2">
              <button className="rounded-lg border border-border px-3 py-1.5 text-xs font-medium transition-colors hover:bg-surface">
                Export CSV
              </button>
              <button className="rounded-lg border border-border px-3 py-1.5 text-xs font-medium transition-colors hover:bg-surface">
                Filters
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr className="transition-colors hover:bg-surface/50">
                  <td className="px-6 py-3">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-surface text-text-secondary flex items-center justify-center text-xs font-bold">
                        JD
                      </div>
      ...
      <Section
        id="modal"
        title="Modal / Dialog"
        description="Modal container pattern used in share dialogs and confirmations."
      >
        <div className="space-y-4">
      ...
      <Section
        ...
        description="Floating menu for actions on cards and table rows."
      >
      ...
      <Section
        id="drawer"
        title="Drawer / Slide-out Panel"
        description="Right-anchored panel used for workspace settings and detail views. Uses React Portal with backdrop blur."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Static Preview</SectionLabel>
            <p className="mt-1 text-xs text-text-muted">
              The Drawer slides in from the right with a blurred backdrop. Closes on Escape or
              backdrop click.
            </p>
            <div
              className="mt-3 relative overflow-hidden rounded-xl border border-border bg-surface"
              style={{ height: 280 }}
            >
              {/* Simulated backdrop */}
              ...
              <div className="absolute right-0 top-0 h-full w-72 bg-surface shadow-2xl flex flex-col">
                ...
                <div className="flex shrink-0 items-center gap-3 border-b border-border px-5 py-3">
                  <div
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary/15 text-sm"
                    style={{ color: "#6366f1" }}
                  >
                    D
                  </div>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2 text-sm text-text-secondary">
              <p>
                <span className="font-medium text-text-primary">Backdrop:</span> bg-black/50,
                backdrop-blur-sm, click to close
              </p>
              <p>
                <span className="font-medium text-text-primary">Panel:</span> max-w-xl, bg-surface,
                shadow-2xl, slide from right
              </p>
              <p>
                <span className="font-medium text-text-primary">Header:</span> icon + title +
                subtitle + close button, border-b
              </p>
              <p>
                <span className="font-medium text-text-primary">Body:</span> flex-1 overflow-y-auto,
      ...
      <Section
        id="theme-toggle"
        title="Theme Toggle"
        description="Compact button for switching between light and dark mode. Always visible in the dashboard header."
      >
        <div className="space-y-6">
          <div>
      ...
      <Section
        id="color-picker"
        title="Color Picker"
        description="Swatch grid for selecting workspace or category colors."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Swatch Grid</SectionLabel>
            <p className="mt-1 text-xs text-text-muted">
              Used in workspace settings. Selected state shows scaled border.
            </p>
      ...
      <Section
        ...
        title="Connection & Sync Badges"
        description="Real-time status indicators used in the board editor."
      >
        <div className="space-y-6">
          <div>
            <SectionLabel>Connection Badge</SectionLabel>
            <p className="mt-1 text-xs text-text-muted">
              Shows WebSocket connection state in the board toolbar.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-text-muted">
              Shows Google Drive sync status when integration is active.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-green-100 px-2.5 py-1 text-[10px] font-medium text-green-700 shadow-sm">
                <svg
      ...
      <Section
        id="auth-card"
        title="Auth Card"
        description="Login/Register card pattern with toggle, social login, and form."
      >
        <div className="mx-auto max-w-[400px]">
          <div className="rounded-xl border border-border bg-surface-raised p-8 shadow-xl">
            ...
            <div className="mb-6 flex rounded-lg bg-surface p-1">
              <button className="flex-1 rounded-lg bg-surface-raised py-2 text-sm font-semibold text-primary shadow-sm">
                Log in
              </button>
              <button className="flex-1 py-2 text-sm font-semibold text-text-muted transition-colors hover:text-text-primary">
                Create account
              </button>
            </div>
            {/* Social */}
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium transition-colors hover:bg-surface">
                Google
              </button>
              <button className="flex items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium transition-colors hover:bg-surface">
                Apple
            ...
            <div className="relative my-6 flex items-center justify-center">
              ...
              <span className="absolute bg-surface-raised px-4 text-xs font-medium uppercase tracking-widest text-text-muted">
                or
              </span>
            </div>
            {/* Form */}
      ...
      {/* Colors in Context */}
      <Section
        id="colors-in-context"
        title="Colors in Context"
        description="How the palette works together in real layouts."
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            <div
              className="flex h-24 items-end rounded-xl p-3"
              style={{ backgroundColor: "#E95B2D" }}
            >
            ...
            <div className="mt-3 grid grid-cols-2 gap-4 max-w-lg">
              <div className="rounded-2xl border border-border bg-surface-raised p-6 transition-all hover:border-primary/50 shadow-sm">
                ...
                <p className="text-xs text-text-secondary leading-relaxed">
                  Work together in real-time. See cursors and changes instantly.
                </p>
              </div>
              <div className="rounded-2xl border border-border bg-surface-raised p-6 transition-all hover:border-accent-coral/50 shadow-sm">
                ...
                <p className="text-xs text-text-secondary leading-relaxed">
                  Leave feedback exactly where it belongs on the canvas.
                </p>
              </div>
            </div>
          </div>

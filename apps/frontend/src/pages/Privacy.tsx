        ...
        <div className="mt-10 space-y-8 text-text-secondary leading-relaxed">
          <section>
            ...
            <p className="mt-2">
              ...
              infrastructure,{" "}
              <strong className="text-text-primary">your data stays on your server</strong>. We (the
              Drawhaus project maintainers) do not collect, store, process, or have access to any
              data you create or store in your self-hosted instance.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              . Font files are loaded from Google Fonts during page load. If this is a concern, you
              may self-host the fonts as well.
            </p>
          </section>
